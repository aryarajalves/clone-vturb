...
import { fetchUsers, deleteUser, fetchInvites } from '../../services/api'
...
export const UserManagementView: React.FC<UserManagementViewProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: '0.8rem', color: '#64748b' }}>
            O SuperAdmin possui proteção de sistema e não pode ser deletado.
          </span>
        </div>
      ...
      {/* Seção de Links de Convites Ativos */}
      {invites.length > 0 && (
        <div
        ...
        >
          ...
          >
            ...
            <h3 style={{ margin: 0, fontSize: '1.05rem', fontWeight: 600, color: '#0f172a' }}>
              Convites Gerados Recentemente ({invites.length})
            </h3>
          </div>
          ...
          <div style={{ overflowX: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
              <thead>
                <tr style={{ backgroundColor: '#f8fafc', borderBottom: '1px solid #e2e8f0' }}>
                  <th style={{ padding: '0.75rem 1.5rem', fontSize: '0.75rem', fontWeight: 600, color: '#475569' }}>
                    TIPO
                  </th>
                  <th style={{ padding: '0.75rem 1.5rem', fontSize: '0.75rem', fontWeight: 600, color: '#475569' }}>
                    STATUS
                  ...
                  <th style={{ padding: '0.75rem 1.5rem', fontSize: '0.75rem', fontWeight: 600, color: '#475569', textAlign: 'right' }}>
                    AÇÃO
                  </th>
                </tr>
              </thead>
                ...
                {invites.slice(0, 5).map((inv) => {
                  ...
                  return (
                    <tr key={inv.id} style={{ borderBottom: '1px solid #f1f5f9' }}>
                      <td style={{ padding: '0.85rem 1.5rem', fontWeight: 600, textTransform: 'capitalize', color: '#1e293b' }}>
                      ...
                      <td style={{ padding: '0.85rem 1.5rem', color: '#64748b', fontSize: '0.85rem' }}>
